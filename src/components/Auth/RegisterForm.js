...
import {ACTION_MENU, SET_ACTION, SET_LOGIN, TRY_REGISTER} from "../../services/game.service";
...
class RegisterForm extends Component {
    render() {
        ...
        return (
            <div className="game-menu form register-form">
                <div className={"group"}>
                    <label htmlFor={"firstname"}>Nombre:</label>
                    <input id={"firstname"}
                           value={login.firstname}
                           onChange={((e) => dispatch({type: SET_LOGIN, payload: { firstname: e.target.value }}))}
                ...
                <div className="button-group">
                    ...
                    <div className="button" onClick={(() => dispatch({type: TRY_REGISTER}))}>Crear usuario</div>
                </div>
            </div>
        );
    }
